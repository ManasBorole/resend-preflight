...
![The checker running against a Resend audience: safe / risky / invalid verdicts with reasons and provider tags](assets/App-ss.png)
...
![preflight_status and preflight_checked_at written back onto a real Resend contact](assets/Preflight-status.png)
